      ...
      <div className="bg-white/80 shadow-md fixed top-0 left-0 w-full z-40 ease-in duration-300 backdrop-blur-md">
        <div className="py-3 px-10 sm:px-4 md:px-6 lg:px-6 container mx-auto">
          <div className="flex items-center justify-between">
            <Link to="/"><img src={logo} alt="" className='h-14 cursor-pointer' /> </Link>
        
            <div className="lg:flex hidden gap-8 items-center">
              <NavLink to="/" className='text-white text-xl font-medium hover:text-black'>Home</NavLink>
              ...
              <Link to="/products" className='text-white text-xl font-medium hover:text-black'>Our Products</Link>
              {user?.user?.type === 'seller' && (
                <Link to="/addproduct" className='text-white text-xl font-medium hover:text-black'>Add Product</Link>
              )}
              {/* <a href="" className='text-white text-xl font-medium hover:text-black'>Popular Products</a> */}
      ...
      <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-white shadow">
        <div className="card-body">
          ...
          <button className='bg-black active:scale-90 transition duration-150 transform
                ...
                mx-auto text-center mb-3 mt-5'  type='submit'>view cart
                </button>
                </Link>
          </div>
        </div>
            ...
            <div className={`lg:hidden absolute w-1/2 sm:w-2/5 h-screen px-4 py-2 text-xl font-medium ease-in shadow-sm backdrop-blur-md bg-white/80 top-0 duration-500 ${nav ? "right-0" : "right-[-100%]" } pt-24`}>
              <div className="flex flex-col gap-8 ">
                <NavLink to="/" className='text-[#191919] text-base font-medium hover:text-red-500'>Home</NavLink>
                <a href="" className='text-[#191919] text-base font-medium hover:text-red-500'>Today's Offer</a>
                <a href="" className='text-[#191919] text-base font-medium hover:text-red-500'>Why Shopper</a>
                <a href="" className='text-[#191919] text-base font-medium hover:text-red-500'>Our Products</a>
                {user?.user?.type === 'seller' && (
                  <NavLink to="/addfood" className='text-[#191919] text-base font-medium hover:text-red-500'>Add Product</NavLink>
                )}
                <a href="" className='text-[#191919] text-base font-medium hover:text-red-500'>Popular Products</a>
                <Link to="/login">
                  <button className='bg-[#F54748] active:scale-90 transition duration-100 transform hover:shadow-xl shadow-md rounded-full px-8 py-2 text-xl font-medium text-white'>Login</button>
                </Link>
              </div>
