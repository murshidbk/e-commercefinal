...
function AddProduct() {
  ...
  return (
    <div className='addproduct bg-black h-screen'>

<div className='w-full mx-auto pt-[16vh]'>
            <form className='ease-in duration-300 w-[80%] sm:w-max shadow-sm backdrop-blur-md
            bg-white/30 lg:w-max mx-auto  rounded-md px-8 py-5' onSubmit={handleSubmit}>
...
<NavLink to='/'>
                ...
                <input type="file" name='myFile' className="file-input file-input-bordered bg-black
          ...
          <select className="select bg-black text-white select-md w-full max-w-xs" 
        name='category'
