...
function ProductPage() {
  ...
  return (
    <div className='pt-[16vh] bg-black h-screen'>
      <div className='py-3 px-10 sm:px-4 md:px-6 lg:px-6'>
        <div className="container mx-auto">
          <PageNavigation title={productDetails?.name} />

          <div className="grid grid-cols-1 md:grid-cols-2 pb-14 gap-8">
            <div className='bg-white/60 border rounded-md mb-5 p-4'>
              <img src={productDetails?.productImage} alt="" className='w-full h-[25rem] cursor-pointer' />
            </div>

            <div className='bg-white/60 border rounded mb-5 p-8 text-black' >
              <div className='text-2xl mb-2 font-bold text-white'>
                {productDetails?.name}
              </div>
              <div className='text-2xl mb-2 font-bold text-white'>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className='flex items-center space-x-4'>
                  <div
                    className='shadow-sm text-white bg-black hover:bg-black cursor-pointer p-4
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:gap-5 sm:mx-auto sm:justify-center">
                <button className='bg-black active:scale-90 transition duration-500 transform
