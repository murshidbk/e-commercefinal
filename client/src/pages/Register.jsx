  ...
  return (
    <div className='register bg-black'>
        <div className='w-full mx-auto pt-[16vh]'>
            ...
            bg-white/30 lg:w-max mx-auto  rounded-md px-8 py-5' onSubmit={handleOnSubmit}>
...
<div className='mb-3'>
                ...
                <div className='mb-3'>
                    ...
                    w-full py-2 px-3  text-ehite leading-tight focus:outline-none
                    focus:shadow-outline' />
                </div>

                <div className='mb-3'>
                    <label htmlFor="type" className='block text-white text-sm mb-2'>
                        Buyer/Seller
                    </label>
                    <input type="text" name='type' placeholder='Please Enter' className='shadow-sm bg-white appearance-none border rounded
                    w-full py-2 px-3  text-white leading-tight focus:outline-none
                    focus:shadow-outline' />
                </div>
