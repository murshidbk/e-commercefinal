...
function ViewCart() {
  ...
  return (
    <div className='pt-14 bg-black h-screen'>
        <div className={cartItems?.length === 0 ? "bg-black h-96":"bg-black"}>
        <div className="container mx-auto py-6 pt-[100px]">
            <div className="w-full bg-white/80 px-10 py-5 text-black rounded-md ">
              ...
              : "mx-auto justify-center items-end px-6 flex-col"}>
                <div className='text-right mb-2 font-semibold text-black'>
                ...
                <div className='btn text-right justify-end ml-auto text-white hover:bg-gray-900 hover:border-black btn-sm bg-black'>
        ...
        <div className='flex items-center hover:bg-gray-100 -mx-8 px-6 py-5'>
            <div className="flex ">
                ...
                <span className='flex items-center space-x-4'>
                    <div className='shadow-sm text-white bg-black hover:bg-blackcursor-pointer p-4
                    ...
                    <span className="text-black px-3 py-2 bg-slate-100 text-lg font-medium">
                        {product.qty}
                    </span>
                    <div className='shadow-sm text-white bg-black hover:bg-black cursor-pointer p-4
